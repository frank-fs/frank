...
- **Design source of truth** lives in `docs/superpowers/specs/2026-04-20-v732-semantic-discovery-design.md`, `2026-04-21-v740-protocol-types-design.md`, and `2026-04-23-v740-resource-oriented-hypermedia-design.md`. The earlier consolidated `DECISIONS.md` / `AUDIT.md` / `STATECHARTS_ARCHITECTURE_DECISIONS.md` documents were removed — recover them from git history if you need the historical investigation.
