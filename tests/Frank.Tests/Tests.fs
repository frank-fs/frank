...
let ``test formatWith properly format as application/xml``() =
    ...
    let result = content.ReadAsStringAsync() |> Async.AwaitTask |> Async.RunSynchronously
    test <@ result = @"<Frank.Tests.TestType xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/""><firstName>Ryan</firstName><lastName>Riley</lastName></Frank.Tests.TestType>" @>
