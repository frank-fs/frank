...
```text
specs/003-datastar-hox-sample/
├── plan.md              # This file
├── research.md          # Hox DSL patterns and integration approach
├── data-model.md        # Entity definitions (same as Basic sample)
├── quickstart.md        # How to run and test the sample
├── contracts/           # API contracts (same as Basic sample)
│   └── api.md
