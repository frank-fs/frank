...
// === Affordance map (loaded from CLI-generated runtime state) ===
// Generated by: frank-cli extract + frank-cli compile
// Runtime state is embedded by Frank.Affordances.MSBuild targets.
