          ...
          AssemblyInfo 
           (fun p -> 
              {p with
                 ...
                 AssemblyTitle = "frank";
                 AssemblyDescription = "A domain specific language for writing simple, composable web applications on top of Frack.";
                 Guid = "E1AFD786-27AE-4834-87FD-A18412DE9715";
