...
Consolidated record of design decisions across the project. Extracted from design documents, GitHub issues, PR descriptions, and spec files across ~285 total decisions mined from all sources.
