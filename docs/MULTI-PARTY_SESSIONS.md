...
> **Status (v7.3.2, April 2026):** The MPST mapping described here survives the v7.3.2 reset unchanged — it is theory, not implementation. The packages it relies on (`Frank.Statecharts`, `Frank.LinkedData`, `Frank.Provenance`, `Frank.Discovery`) do not currently ship and will be rewritten per the v7.4.0 specs: see [2026-04-21 protocol types](superpowers/specs/2026-04-21-v740-protocol-types-design.md) for `TransitionAlgebra` / `DualAlgebra` and projection, and [2026-04-23 resource-oriented hypermedia](superpowers/specs/2026-04-23-v740-resource-oriented-hypermedia-design.md) for the discovery and conformance surfaces. Read this document for the contract; read the specs for the current implementation status.
