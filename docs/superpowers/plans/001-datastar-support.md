---
source: specs/001-datastar-support
type: plan
---
...
> **FR-005 Compliance Required**: The custom operations listed below (except `datastar`) violate FR-005 and are scheduled for removal in tasks.md Phase 1 (T001-T007). After Phase 1 completion, only the `datastar` custom operation will remain on ResourceBuilder.
